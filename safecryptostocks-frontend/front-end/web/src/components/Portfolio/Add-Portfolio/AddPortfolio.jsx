...
const AddPortfolio = ({ portfolioId, isPortfolioAdded, setIsPortfolioAdded, type, portfolioName, portfolioDesc }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post(`http://abhiapi.trafficmanager.net:9000/portfolio/add`, inputs,{params:{userId:id}});
  ...
  const handleEdit = async () => {
    try {
      ...
      const response = await axios.put(`http://abhiapi.trafficmanager.net:9000/portfolio/update`, inputs,{params:{portfolioId:portfolioId}});
