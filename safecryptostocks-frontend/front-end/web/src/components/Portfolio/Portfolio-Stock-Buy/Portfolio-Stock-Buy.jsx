...
const PortfolioStockBuy = ({ portfolioId, isStockAdded, setIsStockAdded }) => {
  ...
  useEffect(() => {
    const getStockPrice = async () => {
      ...
      const response = await axios.get("http://abhiapi.trafficmanager.net:9000/portfolio/getStockById/" + inputs.stockId);
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.put(`http://abhiapi.trafficmanager.net:9000/portfolio/buyStock/${inputs.quantity}`,null,{params:{stockId:inputs.stockId,portfolioId:portfolioId}});
