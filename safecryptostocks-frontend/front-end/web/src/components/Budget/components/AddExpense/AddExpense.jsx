  ...
  const handleChange = (e) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://abhiapi.trafficmanager.net:9000/api/expense/create', expenseData);
            
            if (response.status === 200) {
                axios.get('http://abhiapi.trafficmanager.net:9000/api/expense/all').then((response) => {
                    setExpenses(response.data);
                })

                axios.get('http://abhiapi.trafficmanager.net:9000/api/budget/all').then((response) => {
